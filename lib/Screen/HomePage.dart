                        ...
                        Expanded(
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                  child: Image.asset("assets/images/feedmartlogo.png")),
                            )
                          ),
                        ),
                        Expanded(
                              ...
                              children: [
                                ...
                                InkWell(
                                  onTap: ()=>launch('https://www.instagram.com/'),
                                    child: Image.asset("assets/images/instagram.png",height: 25,width: 25)),
                                SizedBox(width: 11,),
                                InkWell(onTap: (){
                                  Navigator.push(context, MaterialPageRoute(builder: (context)=>NotificationList()));
                                },
                                    child: Image.asset("assets/images/notifaction.png",height: 25,width: 25)),
                    ...
                    child: ListView(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text("Categories",style: TextStyle(color: colors.blackTemp.withOpacity(0.5),fontWeight: FontWeight.bold,fontSize: 15),),
                        ),
                        _catList(),
                        SizedBox(height: 15,),
                        _slider(),
